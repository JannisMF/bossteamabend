...
import de.tensing.bossteam.utils.LuckyWheelActions;
...
public class LuckyWheelController {
    ...
    public String spinWheel() {
        ...
        Price price = new Price(getCurrentTime(), p, priceDTO);
        PRICE.add(price);
        ...
        if (priceDTO.getDisplayText().startsWith("Ihr")
                || priceDTO.getDisplayText().startsWith("Alle")) {
            String message =
        ...
        System.out.println(price.getPrice().getDisplayText());
